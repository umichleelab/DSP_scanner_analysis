...
set min_rest    = 1.5     # minimum rest after each stimulus
...
set stim_durs   = "1.5 1.5 1.5 3 3 3"
set stim_reps   = "25 5 5 25 5 5"
set run_lengths = 300
set labels      = "A B random Amove Bmove random_move"

# ---------------------------------------------------------------------------
# execution parameters
set iterations  = 5000           # number of iterations to compare
set seed        = 1234567       # initial random seed
set outdir      = training_results_1.2TR  # directory that all results are under
...
foreach iter (`count -digits 4 1 $iterations`)
        ...
        make_random_timing.py -num_stim $num_stim -stim_dur $stim_durs  \
                ...
                -min_rest $min_rest                                     \
                -stim_labels $labels                                    \
                -ordered_stimuli A Amove -ordered_stimuli B Bmove -ordered_stimuli random random_move \
                -seed $seed                                             \
                -tr $tr                                                 \
                -show_timing_stats                                      \
                -make_3dd_contrasts										\
