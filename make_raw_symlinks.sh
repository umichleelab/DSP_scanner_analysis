...
ln -s /data/home/tarazlee/DSP/$subject/training/raw_data/anatomy/t1spgr*/eht*.nii.gz anat.nii.gz
...
do
ln -s /data/home/tarazlee/DSP/$subject/$scan/raw_data/func/dsp/run_0$run/tprun_0$run.nii.gz .
